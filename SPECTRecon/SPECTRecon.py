...
def ensure_packages_installed():
    ...
    progress.labelText = "Setting up required python libraries"
    progress.value = 0
...
__package__ = "SPECTRecon"
mod = importlib.import_module("Logic", __name__)
importlib.reload(mod)
__all__ = ["SPECTRecon", "SPECTReconWidget", "SPECTReconLogic", "SPECTReconTest"]


class SPECTRecon(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("SPECT Reconstruction")
        ...
        try:
            ...
            slicer.selfTests = {}
        slicer.selfTests["SPECTReconTest"] = self.runTest
...
class SPECTReconWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath('UI/SPECTRecon.ui'))
        self.layout.addWidget(uiWidget)
        self.ui = slicer.util.childWidgetVariables(uiWidget)
        uiWidget.setMRMLScene(slicer.mrmlScene)
        self.logic = SPECTReconLogic()
        # Connections
    ...
    def hideShowItems(self, called=None, event=None):
        ...
        self.ui.spect_collimator_combobox.setEnabled(not self.ui.advancedPSFCheckBox.checked)
        self.ui.IntrinsicResolutionSpinBox.setEnabled(not self.ui.advancedPSFCheckBox.checked)
    ...
    def onReconstructButton(self):
        ...
        if self.ui.advancedPSFCheckBox.checked:
            advanced_collimator_code = self.ui.advancedPSFComboBox.currentText
        else:
