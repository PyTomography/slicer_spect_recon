...
def selectPrior(prior_type, prior_beta, prior_delta, prior_gamma, files_NM, bed_idx, 
    ...
    if prior_type=='None':
        ...
        if prior_type=='RelativeDifferencePenalty':
            prior = relativeDifferencePenalty(prior_beta=prior_beta, prior_gamma=prior_gamma, prior_weight=prior_weight)
            return prior
        elif prior_type=='Quadratic':
            prior = quadraticPrior(prior_beta=prior_beta, prior_delta=prior_delta, prior_weight=prior_weight)
            return prior
        elif prior_type=='LogCosh':
            prior = logCoshPrior(prior_beta=prior_beta, prior_delta=prior_delta, prior_weight=prior_weight)
            return prior
